#!/usr/bin/env sh
# Universal installer for dicomsweep. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/dicomsweep.git"
echo "Installing dicomsweep ..."
